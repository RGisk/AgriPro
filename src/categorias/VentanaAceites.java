 ...
 */
public class VentanaAceites extends javax.swing.JFrame {
    ...
    public static DefaultTableModel modeloAce;
    TableColumnModel column;
    
    public VentanaAceites() {
        initComponents();
        
        modeloAce = new DefaultTableModel();
        modeloAce.addColumn("Producto");
        modeloAce.addColumn("Cantidad");
        modeloAce.addColumn("Precio");
        modeloAce.addColumn("Precio/Kg");
        this.tabla.setModel(modeloAce);
...
//        this.setBounds((d.width / 2) - (this.getWidth() / 2), (d.height / 2) - (this.getHeight() / 2), 1366, 768);
    ...
    private void initComponents() {
        ...
        icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/aceite.jpg"))); // NOI18N
        icon.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        panelfondo.add(icon);
        icon.setBounds(70, 30, 490, 330);

        description.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        description.setText("<html><p>El aceite de oliva ecológico es un aceite de oliva virgen extra de la mayor calidad, beneficioso para nuestra salud y cuidadoso con el medio ambiente. Disponemos de aceites elaborados con aceitunas de la variedad hojiblanca, picual, cornicabra y muchas más.</p></html>");
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondoace.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAceites.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAceites().setVisible(true);
            }
        });
    }
