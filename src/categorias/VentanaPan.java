...
public class VentanaPan extends javax.swing.JFrame {
    ...
    public static DefaultTableModel modeloPan;
    TableColumnModel column;
    
    public VentanaPan() {
        initComponents();
        
        modeloPan = new DefaultTableModel();
        modeloPan.addColumn("Producto");
        modeloPan.addColumn("Cantidad");
        modeloPan.addColumn("Precio");
        modeloPan.addColumn("Precio/Kg");
        this.tabla.setModel(modeloPan);
...
//        this.setBounds((d.width / 2) - (this.getWidth() / 2), (d.height / 2) - (this.getHeight() / 2), 1366, 768);
    ...
    private void initComponents() {
        ...
        panelfondo.add(icon);
        icon.setBounds(70, 20, 490, 340);

        description.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        description.setText("<html><p>El pan ecológico está elaborado con ingredientes no modificados genéticamente. Sabor tradicional distinto al de los panes industriales.  El pan, parte importante de la dieta en casi todo el mundo, es uno de los alimentos que más consumimos, por lo que debemos de prestar especial atención a sus ingredientes por la gran influencia que puede tener en nuestra salud.  Por ser beneficosos para la salud y por sus sabores a tradición os recomendamos nuestros panes ecológicos. Para el desayuno, la comida, la cena, o para cualquier ocasión.</p></html>");
        panelfondo.add(description);
        description.setBounds(580, 100, 480, 230);
        ...
        jPanel1.setBackground(new java.awt.Color(244, 229, 90));
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondopan.png"))); // NOI18N
