...
public class VentanaBebidas extends javax.swing.JFrame {
    ...
    public static DefaultTableModel modeloBeb;
    TableColumnModel column;
    
    public VentanaBebidas() {
        initComponents();
        
        modeloBeb = new DefaultTableModel();
        modeloBeb.addColumn("Producto");
        modeloBeb.addColumn("Cantidad");
        modeloBeb.addColumn("Precio");
        modeloBeb.addColumn("Precio/Kg");
        this.tabla.setModel(modeloBeb);
...
//        this.setBounds((d.width / 2) - (this.getWidth() / 2), (d.height / 2) - (this.getHeight() / 2), 1366, 768);
    ...
    private void initComponents() {
        ...
        panelfondo.add(icon);
        icon.setBounds(40, 30, 540, 330);

        description.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        description.setText("<html><p> Bebidas espirituosas son aquellas bebidas alcohólicas destinadas al consumo humano, con cualidades organolépticos particulares, con una graduación mínima de 15%vol.  Se trata, así, de productos como el brandy, el whisky, el ron, la ginebra, el vodka, o los licores, aguardientes, etc.</p></html>");
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondobeb.png"))); // NOI18N
