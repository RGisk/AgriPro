 ...
 */
public class VentanaLacteos extends javax.swing.JFrame {
    ...
    public static DefaultTableModel modeloLac;
    TableColumnModel column;
    
    public VentanaLacteos() {
        initComponents();
        
        modeloLac = new DefaultTableModel();
        modeloLac.addColumn("Producto");
        modeloLac.addColumn("Cantidad");
        modeloLac.addColumn("Precio");
        modeloLac.addColumn("Precio/Kg");
        this.tabla.setModel(modeloLac);
...
//        this.setBounds((d.width / 2) - (this.getWidth() / 2), (d.height / 2) - (this.getHeight() / 2), 1366, 768);
    ...
    private void initComponents() {
        ...
        icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/leche.jpg"))); // NOI18N
        icon.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        panelfondo.add(icon);
        icon.setBounds(70, 50, 490, 310);

        description.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        description.setText("<html><p>Los productos como la leche y sus derivados, como los yogures, proveen de proteínas, vitaminas y minerales.\nPero los yogures son una excelente opción para quien no le gusta la leche o para quienes les caiga mal, porque tienen mucho menos lactosa. Además, aportan propiedades nutricionales similares a las de la leche y además contienen bacterias benéficas.</p></html>");
        panelfondo.add(description);
        description.setBounds(580, 80, 480, 230);
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondolac.png"))); // NOI18N
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        VentanaCereales cer = new VentanaCereales();
        cer.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaLacteos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaLacteos().setVisible(true);
            }
        });
    }
