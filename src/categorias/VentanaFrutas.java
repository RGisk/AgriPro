...
public class VentanaFrutas extends javax.swing.JFrame {
    ...
    public static DefaultTableModel modeloFrut;
    TableColumnModel column;
    
    public VentanaFrutas() {
        initComponents();
        
        modeloFrut = new DefaultTableModel();
        modeloFrut.addColumn("Producto");
        modeloFrut.addColumn("Cantidad");
        modeloFrut.addColumn("Precio");
        modeloFrut.addColumn("Precio/Kg");
        this.tabla.setModel(modeloFrut);
...
//        this.setBounds((d.width / 2) - (this.getWidth() / 2), (d.height / 2) - (this.getHeight() / 2), 1366, 768);
    ...
    private void initComponents() {
        ...
        description.setBounds(550, 100, 499, 180);
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondofrut.png"))); // NOI18N
